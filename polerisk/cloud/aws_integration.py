...
class S3DataManager:
    ...
    def upload_file(
        ...
        try:
            ...
            self.s3_client.upload_file(
                str(local_file_path), self.bucket_name, s3_key, ExtraArgs=extra_args
            )
    ...
    def download_file(self, s3_key: str, local_file_path: Union[str, Path]) -> bool:
        """
    ...
    def list_files(
        self, prefix: str = "", file_extension: Optional[str] = None
    ) -> List[Dict]:
        """
    ...
    def upload_dataframe(
        self, df: pd.DataFrame, s3_key: str, format: str = "csv"
    ) -> bool:
        """
    ...
    def download_dataframe(
        self, s3_key: str, format: str = "csv"
    ...
    def get_storage_costs(self) -> Dict:
        ...
        try:
                ...
                if "Contents" in page:
                    for obj in page["Contents"]:
                        ...
                        storage_classes[storage_class] = (
                            storage_classes.get(storage_class, 0) + 1
                        )
            ...
            estimated_monthly_cost = sum(
                (storage_classes.get(storage_class, 0) / object_count * total_size_gb)
                * cost
