...
from polerisk.core.matching import SoilMoistureDataMatcher  # noqa: E402
from polerisk.core.parameters import ParameterManager  # noqa: E402
from polerisk.visualization.plots import plot_time_series  # noqa: E402
...
class TestEndToEndWorkflow(unittest.TestCase):
    ...
    def _create_sample_data(self):
        ...
        dates = pd.date_range(
            self.test_config["start_date"], self.test_config["end_date"], freq="D"
        )
...
class TestModuleIntegration(unittest.TestCase):
    ...
    def test_analysis_and_visualization_integration(self):
        ...
        from polerisk.analysis.statistics import StatisticalAnalyzer
        ...
        plot_path = plot_time_series(
            data.rename(columns={"observed": "in_situ", "predicted": "satellite"}),
            self.temp_dir,
        )
        self.assertTrue(Path(plot_path).exists())
