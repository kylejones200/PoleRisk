...
from polerisk.visualization.plots import (  # noqa: E402
    create_dashboard,
    plot_distributions,
    plot_scatter,
    plot_site_map,
...
class TestVisualizationPlots(unittest.TestCase):
    ...
    def test_plot_vegetation_terrain_analysis_missing_data(self):
        ...
        incomplete_data = pd.DataFrame({"temperature": np.random.uniform(15, 25, 10)})
    ...
    def test_create_dashboard(self, mock_env):
        ...
        with (
            patch("soilmoisture.visualization.plots.plot_time_series") as mock_ts,
            ...
            patch(
                "soilmoisture.visualization.plots.plot_vegetation_terrain_analysis"
            ) as mock_vt,
